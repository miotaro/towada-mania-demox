  ...
  return (
    <>
      ...
      <meta
        ...
        content="/img/favicons/ms-tile-small.jpg"
      />
      <meta
        name="msapplication-square150x150logo"
        content="/img/favicons/ms-tile-medium.jpg"
      />
      <meta
        name="msapplication-wide310x150logo"
        content="/img/favicons/ms-tile-wide.jpg"
      />
      <meta
        name="msapplication-square310x310logo"
        content="/img/favicons/ms-tile-large.jpg"
      />
      <meta name="msapplication-TileColor" content="#FFFFFF" />
      <link
        rel="apple-touch-icon"
        sizes="180x180"
        href="/img/favicons/apple-touch-icon-180.png"
      />
      ...
      <link
        ...
        type="image/png"
        sizes="192x192"
        href="/img/favicons/android-touch-icon-192.png"
      />
